        ...
        <section classNameName="about">
            <div className="about_section_framer">
                <div className="about_section_image">
                    <img src="usapl_competition_photo 2.jpg" alt="Photo of Daniel Bird" />
                </div>
...
//see if i need to add the first_section to all pages because i cant add them to here bc only 1 component allowed